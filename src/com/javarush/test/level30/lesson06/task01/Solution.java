...
public class Solution {
    ...
    public static void checkAFlag(D d) {
        if (d != null && d.cs != null && !d.cs.isEmpty() && d.cs.get(0) != null && d.cs.get(0).bs != null && !d.cs.get(0).bs.isEmpty() && d.cs.get(0).bs.get(0) != null && d.cs.get(0).bs.get(0).as != null && !d.cs.get(0).bs.get(0).as.isEmpty() && d.cs.get(0).bs.get(0).as.get(0) != null && d.cs.get(0).bs.get(0).as.get(0).flag) {
