...
public class Solution {
    ...
    public static Number convertNumberToOtherNumerationSystem(Number number, NumerationSystem expectedNumerationSystem) {
        int currentNumerationSystemValue = number.getNumerationSystem().getNumerationSystemIntValue();
        int expectedNumerationSystemValue = expectedNumerationSystem.getNumerationSystemIntValue();

        BigInteger result = new BigInteger(number.getDigit(), currentNumerationSystemValue);
        return new Number(expectedNumerationSystem, result.toString(expectedNumerationSystemValue));
    }
}
